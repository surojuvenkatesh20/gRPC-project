...
// Validate checks the field values on StudentsCount with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *StudentsCount) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on StudentsCount with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in StudentsCountMultiError, or
// nil if none found.
func (m *StudentsCount) ValidateAll() error {
	return m.validate(true)
}

func (m *StudentsCount) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	// no validation rules for StudentsCount

	if len(errors) > 0 {
		return StudentsCountMultiError(errors)
	}

	return nil
}

// StudentsCountMultiError is an error wrapping multiple validation errors
// returned by StudentsCount.ValidateAll() if the designated constraints
// aren't met.
type StudentsCountMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m StudentsCountMultiError) Error() string {
...
func (m StudentsCountMultiError) AllErrors() []error { return m }

// StudentsCountValidationError is the validation error returned by
// StudentsCount.Validate if the designated constraints aren't met.
type StudentsCountValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
func (e StudentsCountValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e StudentsCountValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e StudentsCountValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e StudentsCountValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e StudentsCountValidationError) ErrorName() string { return "StudentsCountValidationError" }

// Error satisfies the builtin error interface
func (e StudentsCountValidationError) Error() string {
	cause := ""
	if e.cause != nil {
...
var _ error = StudentsCountValidationError{}
...
func (m *TeacherId) validate(all bool) error {
	...
	if !_TeacherId_Id_Pattern.MatchString(m.GetId()) {
		err := TeacherIdValidationError{
			field:  "Id",
			reason: "value does not match regex pattern \"^[a-fA-F0-9]{18$}\"",
		}
		if !all {
			return err
		}
...
var _TeacherId_Id_Pattern = regexp.MustCompile("^[a-fA-F0-9]{18$}")
...
func (m *Teacher) validate(all bool) error {
	...
	if !_Teacher_Id_Pattern.MatchString(m.GetId()) {
		err := TeacherValidationError{
			field:  "Id",
...
var _Teacher_Id_Pattern = regexp.MustCompile("^[a-fA-F0-9]{24}$")

var _Teacher_FirstName_Pattern = regexp.MustCompile("^[a-zA-z0-9 ]*$")

var _Teacher_LastName_Pattern = regexp.MustCompile("^[a-zA-z0-9 ]*$")
