...
const (
	...
	TeachersService_GetStudentsCountByClassTeacher_FullMethodName = "/main.TeachersService/GetStudentsCountByClassTeacher"
)
...
type TeachersServiceClient interface {
	...
	GetStudentsCountByClassTeacher(ctx context.Context, in *TeacherId, opts ...grpc.CallOption) (*StudentsCount, error)
}
...
func (c *teachersServiceClient) GetStudentsCountByClassTeacher(ctx context.Context, in *TeacherId, opts ...grpc.CallOption) (*StudentsCount, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StudentsCount)
	err := c.cc.Invoke(ctx, TeachersService_GetStudentsCountByClassTeacher_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TeachersServiceServer interface {
	...
	GetStudentsCountByClassTeacher(context.Context, *TeacherId) (*StudentsCount, error)
...
func (UnimplementedTeachersServiceServer) GetStudentsCountByClassTeacher(context.Context, *TeacherId) (*StudentsCount, error) {
	return nil, status.Error(codes.Unimplemented, "method GetStudentsCountByClassTeacher not implemented")
}
...
func _TeachersService_GetStudentsCountByClassTeacher_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TeacherId)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TeachersServiceServer).GetStudentsCountByClassTeacher(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TeachersService_GetStudentsCountByClassTeacher_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TeachersServiceServer).GetStudentsCountByClassTeacher(ctx, req.(*TeacherId))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TeachersService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetStudentsCountByClassTeacher",
			Handler:    _TeachersService_GetStudentsCountByClassTeacher_Handler,
		},
	},
