...
type SortField struct {
	...
	OrderBy       Order                  `protobuf:"varint,2,opt,name=orderBy,proto3,enum=main.Order" json:"orderBy,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SortField) GetOrderBy() Order {
	if x != nil {
		return x.OrderBy
	}
	return Order_ASC
...
const file_students_proto_rawDesc = "" +
	"\n" +
	"\x0estudents.proto\x12\x04main\x1a\x17validate/validate.proto\"9\n" +
	"\tStudentId\x12,\n" +
	"\x02id\x18\x01 \x01(\tB\x1c\xfaB\x19r\x17\x10\x18\x18\x182\x11^[a-fA-F0-9]{24}$R\x02id\"9\n" +
	"\n" +
	"StudentIds\x12+\n" +
	"\x03ids\x18\x01 \x03(\v2\x0f.main.StudentIdB\b\xfaB\x05\x92\x01\x02\b\x01R\x03ids\"T\n" +
	...
	"\aorderBy\x18\x02 \x01(\x0e2\v.main.OrderR\aorderBy\"\xd7\x01\n" +
	"\aStudent\x12\x19\n" +
	"\x02id\x18\x01 \x01(\tB\t\xfaB\x06r\x04\x10\x18\x18\x18R\x02id\x122\n" +
	"\n" +
	...
	"\x05class\x18\x05 \x01(\tB\x16\xfaB\x13r\x112\x0f^[a-zA-z0-9 ]*$R\x05class\"?\n" +
	"\bStudents\x123\n" +
	"\bstudents\x18\x01 \x03(\v2\r.main.StudentB\b\xfaB\x05\x92\x01\x02\b\x01R\bstudents*\x1a\n" +
	"\x05Order\x12\a\n" +
...
var file_students_proto_goTypes = []any{
	...
	(*DeleteStudentsConfirmation)(nil), // 3: main.DeleteStudentsConfirmation
...
var file_students_proto_depIdxs = []int32{
	...
	5, // 2: main.GetStudentsRequest.sortBy:type_name -> main.SortField
	0, // 3: main.SortField.orderBy:type_name -> main.Order
	...
	3, // 12: main.StudentsService.DeleteStudents:output_type -> main.DeleteStudentsConfirmation
